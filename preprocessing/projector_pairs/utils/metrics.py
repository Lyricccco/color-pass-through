...
def calculate_psnr(img1, img2, crop_border=0, input_order='HWC', test_y_channel=False, **kwargs):
...
def calculate_ssim(img1, img2, crop_border=0, input_order='HWC', test_y_channel=False, **kwargs):
